...
export function WishlistItemCard({
  ...
  return (
    <div className="flex flex-col rounded-xl border border-gray-200 p-4 shadow-sm hover:shadow-md transition-shadow w-[49%]">
      <div className="flex justify-between items-start pb-4">
        <div className="text-xl ">{title}</div>
        <StatusBadge status={status} />
      </div>
      <div className="flex pb-4">
        <div className="w-1/4 h-32 object-cover rounded">{thumbnail}</div>
        <div>
